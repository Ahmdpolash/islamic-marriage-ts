...
import h1 from "../../assets/community/details.png";
import h2 from "../../assets/community/h1.png";
import h3 from "../../assets/community/h2.png";
import h4 from "../../assets/community/h3.png";
import h5 from "../../assets/community/h4.png";
import h6 from "../../assets/community/h5.png";
import h7 from "../../assets/community/h6.png";
        ...
        <div className="my-4 lg:my- pt-4 lg:pt-6 lg:pb-">
          ...
          <div className="my-4 mt-5 lg:mt-10">
            <h1 className="text-[18px] font-medium tracking-wide flex items-center gap-2 mb-3 lg:mb-6 text-[#522B79] ">
              <IoMdBookmark className="text-purple text-[23px]" /> See more
              community centers
            </h1>
